#' extract_osm_objects2
#'
#' Copy of extract_osm_objects modified to use code from hrbrmstr rather than
#' 'osmar'. Only implemented here for highways.
#'
...
#' obj <- extract_osm_objects2 (bbox=bbox)

extract_osm_objects2 <- function (bbox=NULL)
{
    ...
    # from htbrmstr/overpass/overpass_query.r
    res <- httr::POST (url_base, body=query)
    httr::stop_for_status (res) 
    doc <- xml2::read_xml (httr::content (res, as='text'))

    message ("converting OSM data to sp objects")
