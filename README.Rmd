...
> [!IMPORTANT]  
> You are responsible for following the [Usage Policy](https://wiki.openstreetmap.org/wiki/Overpass_API#Public_Overpass_API_instances).
> of the server you are connected to. See [`get_overpass_url()`](https://docs.ropensci.org/osmdata/reference/get_overpass_url.html)
> to check the server.
>
> You can modify the user agent of the requests by setting the option `osmdata.user_agent`:
> 
> ```r
