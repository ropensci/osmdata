...
including as [Simple Features (`sf`)](https://cran.r-project.org/package=sf) or
...
functionsis then sent to the [overpass server](https://overpass-turbo.eu) to
...
either restanrants OR pubs with
```{r OR}
