...
`Rcpp` routines is obviously enourmously faster. The package currently downloads
and converts points, lines, and polygons, with the three respective functions:
...
`osmdatar` is thus over 20 times faster than the internal `R` routines of
`osmar`.
