...
[`Spatial`](http://cran.r-project.org/package=sp) objects. `overpass` has its
...
the [interactive online query builder](http://overpass-turbo.eu), which inludes a
helful corrector function for incorrectly formatted queries. An `osmdata` query
...
OSM data are strucutred in three hierarchical levels:
