...
[Simple Features (SF)](https://www.opengeospatial.org/standards/sfo) 
format, defined by the
[Open Geospatial Consortium](https://www.opengeospatial.org), and implemented in
...
a so-called ['driver' for OSM data](https://www.gdal.org/drv_osm.html). This
